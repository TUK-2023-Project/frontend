      ...
      <div className={styles.content}>
        <div className={styles["content__card-wrapper"]}>
          <img
            ...
            alt="Image 1"
          />
          <h2 className={styles["content__card-wrapper__label"]}>{"ㄱ"}</h2>
        </div>
        <div className={styles["content__card-wrapper"]}>
          <img
            src=" https://www.korean.go.kr/asset/img/SJ/img_001_1.jpg"
            ...
            className={styles["content__card-wrapper__image"]}
          />
          <h2 className={styles["content__card-wrapper__label"]}>{"ㄴ"}</h2>
        </div>
        <div className={styles["content__card-wrapper"]}>
          <img
            ...
            className={styles["content__card-wrapper__image"]}
          />
          <h2 className={styles["content__card-wrapper__label"]}>{"ㄷ"}</h2>
        </div>
      </div>
