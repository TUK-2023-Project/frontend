  ...
  return (
    <div>
      <div className="header">
        <h1 className="header__title">{"1번 문제 입니다."}</h1>
      ...
      <div className="content">
        <div className="content__card-wrapper">
          <img
            className="content__card-wrapper__image"
            src=" https://www.korean.go.kr/asset/img/SJ/img_001_1.jpg"
            alt="Image 1"
          />
          <h2 className="content__card-wrapper__label">{"ㄱ"}</h2>
        </div>
        <div className="content__card-wrapper">
          <img
            src=" https://www.korean.go.kr/asset/img/SJ/img_001_1.jpg"
            ...
            className="content__card-wrapper__image"
          />
          <h2 className="content__card-wrapper__label">{"ㄴ"}</h2>
        </div>
        <div className="content__card-wrapper">
          <img
            ...
            className="content__card-wrapper__image"
          />
          <h2 className="content__card-wrapper__label">{"ㄷ"}</h2>
        </div>
      </div>
